...
What is on the y-axis, row, col, x-axis, label, and color? This is defined in the cross-tab window. Each Operator requires to its the correct Input Projection.
